...
def generate_launch_description():
    ...
    map_file_path = os.path.join(pkg_share, 'map', '/home/teamone/ros2_ws3/src/my_robot_pkg/map/map_wall_202.yaml')
    ...
    # 8. [추가됨] AI 검사 봇 (Inspector)
    # setup.py에 'inspection = ...' 등록 필수
    start_inspection_cmd = Node(
        package=pkg_name,
    ...
    ld.add_action(start_inspection_cmd)
